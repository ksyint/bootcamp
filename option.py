...
def parse_args():
    ...
    parser.add_argument('--lr', type=str, default='[0.0000000000005]*15000', help='learning rates for steps(list form) default:0.001')
                                                  #'[0.001]*15000'

    parser.add_argument('--batch_size', type=int, default=4, help='number of instances in a batch of data (default: 16)')
    ...
    parser.add_argument('--pretrained_ckpt', default= "checkpoints/197_2.pth", help='ckpt for pretrained model')
